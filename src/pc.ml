...
type pc_process = { pc_process_name: string; (** Process name **)
                    ...
                    pc_process_set: string; (** Set in which process is taken
...
type pc_prog = { pc_prog_name: string; (** Program name **)
                 ...
                 pc_glob_var: ((pc_var * int option) * pc_expr) list; (** Global program variables with their names and array sizes,
